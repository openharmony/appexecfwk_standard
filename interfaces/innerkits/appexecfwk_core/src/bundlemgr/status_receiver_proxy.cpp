...
const std::string MSG_ERR_INSTALL_GRANT_REQUEST_PERMISSIOMS_FAILED =
    "[MSG_ERR_INSTALL_GRANT_REQUEST_PERMISSIOMS_FAILED]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_GRANT_REQUEST_PERMISSIOMS_FAILED,
