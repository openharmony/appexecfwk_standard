...
const std::string MSG_ERR_INSTALL_SINGLE_USER_NOT_SAME = "[MSG_ERR_INSTALL_SINGLE_USER_NOT_SAME]";
...
const std::map<int32_t, struct ReceivedResult> MAP_RECEIVED_RESULTS {
    ...
    {ERR_APPEXECFWK_INSTALL_SINGLE_USER_NOT_SAME,
        {IStatusReceiver::ERR_INSTALL_SINGLE_USER_NOT_SAME, MSG_ERR_INSTALL_SINGLE_USER_NOT_SAME}},
