...
const std::string DISTRIBUTED_FILE = "/data/service/el2/%/hmdfs/account/device_view/local/data/";
const std::string DISTRIBUTED_FILE_NON_ACCOUNT = "/data/service/el2/%/hmdfs/non_account/device_view/local/data/";
