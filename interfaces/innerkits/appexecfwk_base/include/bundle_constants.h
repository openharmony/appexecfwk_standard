...
const std::string DISTRIBUTED_FILE = "/mnt/hmdfs/%/account/device_view/local/data/";
const std::string DISTRIBUTED_FILE_NON_ACCOUNT = "/mnt/hmdfs/%/non_account/device_view/local/data/";
