...
enum {
    ...
    // install sandbox app
    ERR_APPEXECFWK_SANDBOX_INSTALL_FAILED_APP_NOT_EXISTED,
    ...
    ERR_APPEXECFWK_SANDBOX_INSTALL_NOT_INSTALLED_AT_CURRENT_USERID,
    ERR_APPEXECFWK_SANDBOX_INSTALL_NO_SANDBOX_APP_INFO,
    ERR_APPEXECFWK_SANDBOX_INSTALL_DELETE_ACCESSTOKEN_FAILED,
