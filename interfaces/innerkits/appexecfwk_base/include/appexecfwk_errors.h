...
enum {
    ...
    ERR_APPEXECFWK_FORM_INTENT_PARCEL,
    ...
    ERR_APPEXECFWK_FORM_ADD_DEATH_RECIPIENT_FAILED,
    ERR_APPEXECFWK_FORM_BIND_FORMSUPPLY_FAILED,
    ERR_APPEXECFWK_FORM_INVALID_PARAM,
    ERR_APPEXECFWK_FORM_CFG_NOT_MATCH_ID,
    ERR_APPEXECFWK_FORM_ADD_NOT_EXIST_ID,
    ...
    ERR_APPEXECFWK_FORM_SUPPLIER_DEL_FAIL,
    ...
    ERR_APPEXECFWK_FORM_HOST_INFO_NOT_EXIST,
    ERR_CODE_COMMON,
    ERR_NOT_EXIST_ID,
    ERR_MAX_RECORDS_PER_APP,
    ERR_PERMISSION_DENY,
    ...
    ERR_FORM_INVALID_PARAM,
    ERR_DELETE_FORM_TIMER,
    ERR_CFG_NOT_MATCH_ID,
    ERR_APPEXECFWK_FORM_DBCACHE_FIND_FAIL,
    ERR_APPEXECFWK_FORM_JSON_CREATE_DIR_FAIL,
    ERR_APPEXECFWK_FORM_JSON_NEW_FILE_FAIL,
    ERR_APPEXECFWK_FORM_JSON_NO_DIR,
    ERR_APPEXECFWK_FORM_JSON_OPEN_FAIL,
    ERR_APPEXECFWK_FORM_JSON_FILE_EMPTY,
    ERR_APPEXECFWK_FORM_JSON_FIND_FAIL,
    ERR_APPEXECFWK_FORM_JSON_PARSE_FAIL,
    ERR_APPEXECFWK_FORM_JSON_DELETE_FAIL,
