    ...
    const int32_t result, const FormJsInfo &formJsInfo) const
{
    ...
    if (this->caseName_ == FORM_EVENT_RECV_PERFORMANCE_TEST_0100) {
        ...
        FormTestUtils::PublishEvent(this->caseName_, 501, std::to_string(formJsInfo.formId));
    } else {
...
void FormAbilityPerformance::PerformanceFormCallback::OnUpdate(const int32_t result, const FormJsInfo &formJsInfo) const
{
    ...
    if (this->caseName_ == FORM_EVENT_RECV_PERFORMANCE_TEST_0100) {
        ...
        FormTestUtils::PublishEvent(this->caseName_, 502, "true");
    } else {
...
void FormAbilityPerformance::FMS_performanceTest_0100(std::string data)
{
    std::shared_ptr<PerformanceFormCallback> callback =
        std::make_shared<PerformanceFormCallback>(FORM_EVENT_RECV_PERFORMANCE_TEST_0100, 100);
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0100, 100, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_0200(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0200, 200, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_0200] DeleteForm error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0200, 200, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_0300(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0300, 300, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_0300] ReleaseForm error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0300, 300, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_0400(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0400, 400, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_0400] CastTempForm error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0400, 400, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_0500(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0500, 500, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_0500] NotifyVisibleForms error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0500, 500, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_0600(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0600, 600, "true");
    } else {
...
void FormAbilityPerformance::FMS_performanceTest_0700(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_0700, 700, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_0700] RequestForm error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1300, 700, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_1300(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1300, 1300, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_1300] GetAllFormsInfo error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1300, 1300, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_1400(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1400, 1400, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_1400] GetFormsInfoByApp error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1400, 1400, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_1500(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1500, 1500, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_1500] GetFormsInfoByModule error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1500, 1500, "false");
    }
}
...
void FormAbilityPerformance::FMS_performanceTest_1600(std::string data)
{
    ...
    if (bResult) {
        ...
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1600, 1600, "true");
    } else {
        APP_LOGE("[FMS_performanceTest_1600] CheckFMSReady error");
        FormTestUtils::PublishEvent(FORM_EVENT_RECV_PERFORMANCE_TEST_1600, 1600, "false");
    }
}
