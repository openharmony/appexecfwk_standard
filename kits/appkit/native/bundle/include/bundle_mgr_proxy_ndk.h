...
#ifndef FOUNDATION_APPEXECFWK_KITS_APPKIT_NATIVE_BUNDLEMGR_INCLUDE_BUNDLEMGR_BUNDLE_MGR_PROXY_NDK_H
#define FOUNDATION_APPEXECFWK_KITS_APPKIT_NATIVE_BUNDLEMGR_INCLUDE_BUNDLEMGR_BUNDLE_MGR_PROXY_NDK_H
...
class BundleMgrProxyNdk : public IRemoteProxy<IBundleMgr> {
public:
    explicit BundleMgrProxyNdk(const sptr<IRemoteObject> &impl);
    virtual ~BundleMgrProxyNdk() override;
    /**
...
private:
    ...
    static inline BrokerDelegator<BundleMgrProxyNdk> delegator_;
};

}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // FOUNDATION_APPEXECFWK_KITS_APPKIT_NATIVE_BUNDLEMGR_INCLUDE_BUNDLEMGR_BUNDLE_MGR_PROXY_NDK_H