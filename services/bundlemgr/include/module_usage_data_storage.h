...
private:
    ...
    void AbilityRecordToKey(const std::string &userId, const std::string &deviceId, const std::string &bundleName,
        const std::string &moduleName, std::string &key) const;
    void InnerBundleInfoToKeys(
        const InnerBundleInfo &data, int32_t userId, std::vector<DistributedKv::Key> &keys) const;
    void FillDataStorageKeys(const std::string &userId, const std::string &bundleName, const std::string &moduleName,
    ...
    void SaveEntries(
        const std::vector<DistributedKv::Entry> &allEntries, std::vector<ModuleUsageRecord> &records) const;
